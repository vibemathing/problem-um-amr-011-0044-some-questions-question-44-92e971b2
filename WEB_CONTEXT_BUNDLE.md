...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:um-amr-011-0044-some-questions-question-44-92e971b2",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-011-0044-5f473c53959f",
        "url": "https://www.unsolvedmath.com/problems/AMR-011-0044"
      }
    ],
    "statement": {
      "language": "en",
      "text": "For a free action of $\\Gamma$ on $X$, is $\\operatorname{cost}(\\Gamma,X)=\\operatorname{cost}(\\Gamma,X\\times X)$ for the diagonal action on $X\\times X$?",
      "version": 1
    },
    "title": "Some Questions — Question 44",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "9505adfdcfd126feabcb86f408187c503418a9746e1024998e64cdc8e4dfc961"
}
```
